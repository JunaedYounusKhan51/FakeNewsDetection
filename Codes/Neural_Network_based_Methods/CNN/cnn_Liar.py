...
print("Saving Model...")
model_name = 'Models/Model_cnn_Liar_2.h5'########################################3
...
'''
model = load_model('Models/Model_cnn_Liar_2.h5')
model.name='Model_cnn_Liar_2.h5'
'''
...
import pickle
with open('Predictions/pickle_Pred_CNN_1_Liar.pickle','wb') as f:
