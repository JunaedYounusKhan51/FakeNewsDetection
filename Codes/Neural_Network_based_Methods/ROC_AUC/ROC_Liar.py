...
#####################################################################################
pickle_load=open('Predictions/pickle_Pred_CNN_1_Liar.pickle','rb')
...
#####################################################################################
#####################################################################################
pickle_load=open('Predictions/pickle_Pred_bi_LSTM_1_Liar.pickle','rb')
y_test,y_pred=pickle.load(pickle_load)
auc = roc_auc_score(y_test, y_pred)
print('AUC: %.3f' % auc)
# calculate roc curve
...
####################################################################################
#####################################################################################
pickle_load=open('Predictions/pickle_Pred_CLSTM_1_Liar.pickle','rb')
y_test,y_pred=pickle.load(pickle_load)
auc = roc_auc_score(y_test, y_pred)
print('AUC: %.3f' % auc)
# calculate roc curve
...
#####################################################################################
#####################################################################################
pickle_load=open('Predictions/pickle_Pred_Conv_HAN_1_Liar.pickle','rb')
y_test,y_pred=pickle.load(pickle_load)
auc = roc_auc_score(y_test, y_pred)
print('AUC: %.3f' % auc)
# calculate roc curve
...
#plt.title('ROC Liar',size=30)
#plt.show()
plt.savefig('ROC_Liar.png')
