...
recipes = pd.read_csv('fake_or_real_news_train_feature.csv')
#recipes
...
X = recipes[['Article_len','Avg_Word_Len','CountOfNumbers','CountofExclamation','adjectives','WordCount']].as_matrix()
